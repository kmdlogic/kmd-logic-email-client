...
# Refer to the link - https://github.com/Azure/autorest.csharp
 ...
 autorest --input-file=email.swagger.json --output-folder=. --namespace=Kmd.Logic.Email.Client --csharp --legacy --override-client-name=InternalClient --add-credentials
